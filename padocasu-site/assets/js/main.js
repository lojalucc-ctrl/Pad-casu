...
(function () {
  ...
  var variedade = [
    ['pao-redondo',    'Pães',         'a partir de R$ 22', '#c-paes',       'Pães redondos de fermentação natural'],
    ['torta',          'Tortas',       'a partir de R$ 38', '#c-tortas',     'Torta cremosa dourada'],
    ['homus',          'Pastinhas',    'a partir de R$ 18', '#c-pastinhas',  'Pastinhas embaladas sobre folha de bananeira'],
    ...
    ['geleias',        'Geleias',      'R$ 28',             '#c-geleias',    'Potes de geleia caseira contra a luz'],
    ['granola',        'Granola',      'R$ 22',             '#c-granola',    'Granola rica com castanhas e sementes'],
    ['bolo',           'Bolo',         'R$ 45',             '#c-bolo',       'Bolo com frutas cristalizadas e castanhas']
  ];
  ...
  var fotos = [
    ['pao-jardim', 'Pães esfriando na grade, no quintal'],
    ['focaccia', 'Focaccias saindo do forno'],
    ['coalhada', 'Coalhada seca sobre folha de bananeira'],
    ['bolos-mesa', 'Bolos e geleias na mesa de madeira'],
    ['pao-trancado', 'Pães trançados recém-assados'],
    ['mesa-farta', 'Mesa farta com pães e pastinhas'],
    ...
    ['focaccia2', 'Focaccias com tomate e azeitona'],
    ...
    ['pao-rack', 'Pães redondos na grade']
  ];
